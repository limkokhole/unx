### Problem
Everytime I run command to extarct file,  I always worry some files might merged into old directory(same name) without alert which corrupt the old directory structure or lose the file tracking.
